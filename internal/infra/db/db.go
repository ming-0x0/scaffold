...
import (
	...
	"github.com/ming-0x0/scaffold/internal/infra/logger/gormlog"
...
func NewDB(
	...
	dbConn, err = gorm.Open(mysql.Open(dsn), &gorm.Config{
		Logger: gormlog.New(gormlog.Logger{
...
func CloseDB(
	...
	myDB, err := db.DB()
	if err != nil {
		logger.Errorf("Error while returning *sql.DB: %v", err.Error())
		return
	}
	...
	if err := myDB.Close(); err != nil {
		logger.Errorf("Error while closing the master DB connection pool: %v", err.Error())
		return
	}
}
